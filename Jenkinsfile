      ...
      stage('Challenge') {
        input {
            ...
            parameters {
              ...
              script:
                [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: 'return ["socks", "valleys", "jumps"]']]]
              ...
              script:
                [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: 'return \'\''], script: [classpath: [], sandbox: false,
              script: 
              '''
                switch(Challenge) { case "socks": return "1 1 2 2 3 3 3" case "valleys": return "DDUDUUUUDDUDDU" case "jumps": return "0 0 1 0 0 1 0"}
              ''']]]
            }
          }
          agent {
